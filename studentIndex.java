...
public class studentIndex extends javax.swing.JFrame {
    ...
    public studentIndex(String regno) {
        initComponents();
        jTextField5.setText(regno);
    }
    /**
    ...
    private void initComponents() {
        ...
        jLabel26.setText("Your ScoreCard Is Below");

        jButton1.setFont(new java.awt.Font("Segoe UI Emoji", 1, 18)); // NOI18N
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/student_result_management_portal/left-arrow.png"))); // NOI18N
        ...
        jTextField13.setFont(new java.awt.Font("Segoe UI Historic", 1, 18)); // NOI18N
        ...
        try{
            ...
            if(rs.next()){
                ...
                if(s1<32 || s2<32 || s3<32 || s4<32 || s5<32){
                    ...
                    jLabel29.setText("Congratulations You Passed!");
                }
            }   
            else{
